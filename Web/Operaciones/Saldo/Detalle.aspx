...
<asp:Content ID="Content1" ContentPlaceHolderID="ChildContent" runat="server" >
    ...
    <div style="position:relative; float:left; font-size:large;">
        <asp:DetailsView ID="dtvDetalles" runat="server" Height="50px" Width="350px" BorderWidth="0px"
            AutoGenerateRows="False" BorderStyle="None"  CellPadding="0" CellSpacing="10">
              <Fields>
