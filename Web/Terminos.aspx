<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.Master" AutoEventWireup="true" CodeBehind="Terminos.aspx.cs" Inherits="Web.Terminos" Title="SERVITARJETA" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="Terminos">
            
             <h1>Términos y Condiciones de Uso y Privacidad</h1>          
    <div>
        &nbsp;<div >
                <p>
                    
Este Sitio Web servitarjeta.com es operado por
ServiTarjeta TDC C.A. y se encuentra a su
disposición para fines informativos. Al acceder o utilizar este Sitio Web, usted
acepta estos Términos y Condiciones de Uso y Privacidad. Si usted no acepta los
Términos y Condiciones de Uso, usted no puede utilizar este Sitio Web.
Registro. Contraseña
...
3) Incumple cualquier normativa aplicable respecto del acceso o el uso de la
presente Página Web.


Link

Este Sitio Web puede incluir conexiones a otros sitios web operados por otras
compañías de Sevitarjeta y/o operados por terceros. Estas conexiones son provistas
...
sitios. Sitios web de terceros pueden contener información con la cual SERVITARJETA
...
Este Sitio Web (incluyendo todo su contenido) es propiedad de Servitarjeta TDC C.A.
o de sus licenciantes y está protegido por leyes de derecho de autor, de
marcas y otras de Perú y de otros países. Excepto cuando fuera expresamente
...
Este Sitio Web incluye y presenta logos, logotipos y otras marcas comerciales y
marcas de servicio que son propiedad de, o son licenciadas a, varias afiliadas de
SERVITARJETA. El Sitio Web también puede incluir marcas comerciales o marcas de
...
, sea que se fijen públicamente o se transmitan privadamente. En tal
caso, dicho Contenido es únicamente responsabilidad de la persona que lo
originó. Esto significa que usted (y no SERVITARJETA) es enteramente responsable por
...
Sitio Web contará con un moderador (SERVITARJETA) que estará facultado a eliminar el
Contenido que le parezca impropio. Asimismo, SERVITARJETA eliminará todo Contenido
ante la denuncia de aquellos terceros que se vean afectados y/o lesionados en
sus derechos. Bajo ninguna circunstancia SERVITARJETA será responsable en cualquier
...
• Sea ilegal, peligroso, amenazante, abusivo, hostigador, tortuoso,
...
• Hacerse pasar por alguna persona o entidad, incluyendo, pero sin
limitarse, a un funcionario o empleado de SERVITARJETA o hacer declaraciones
falsas, o de cualquier otra forma falsificar su asociación a alguna persona
o entidad;
• Falsificar encabezados o de cualquier otra forma manipular identificadores
para desviar el origen de algún Contenido transmitido por medio del Sitio
Web;
• Cargar ("upload"), publicar, enviar por correo electrónico, transmitir, o de
...
confidencialidad);
• Cargar, publicar, enviar por correo electrónico, transmitir, o de cualquier
...
telecomunicaciones;
• Interrumpir el flujo normal de diálogo, hacer que una pantalla se mueva
...
reales; 
• Interferir o interrumpir el Sitio Web, servidores, o redes conectadas al Sitio
Web, o desobedecer cualquier requisito, procedimiento, política o
regulación de redes conectadas al Sitio Web;
• Violar con o sin intención alguna ley local, estatal, nacional o
...
SERVITARJETA en ningún caso será responsable por la destrucción o eliminación de la
información que los Visitantes incluyan en sus mensajes.
Privacidad del Visitante
Será de aplicación sobre la Privacidad del Visitante lo estipulado en el siguiente
link: http://servitarjeta.com/pe/.
...
Advertencia: SERVITARJETA no solicita información de tipo financiera ni
bancaria. Todo mensaje que solicite dicha información no proviene de SERVITARJETA.
...
SERVITARJETA. Aquellos que deseen tener acceso a sus datos personales y/o
...
SERVITARJETA NO DECLARA NI GARANTIZA QUE EL CONTENIDO DEL SITIO WEB
...
MAYOR MEDIDA PERMITIDA CONFORME A LA LEY APLICABLE, SERVITARJETA 
...
SERVITARJETA NO DECLARA NI GARANTIZA QUE LAS FUNCIONES
...
SERVITARJETA NO EFECTÚA NINGUNA DECLARACIÓN O GARANTÍA RESPECTO
...
NO SERVITARJETA) ASUME TODO EL COSTO DE TODOS LOS SERVICIOS,
REPARACIONES O CORRECCIONES QUE FUERAN NECESARIOS.
LIMITACIÓN DE RESPONSABILIDAD
CON EL MAYOR ALCANCE PERMITIDO POR LA LEGISLACIÓN APLICABLE, UD.
ENTIENDE Y ACUERDA QUE NI SERVITARJETA NI CUALQUIERA DE SUS
...
SERVITARJETA tiene sede en Perú y este Sitio Web es operado en Perú. Ud. acepta en
forma irrevocable la jurisdicción de los tribunales de la Ciudad de Lima, en
relación con cualquier acción para la ejecución de estos términos y condiciones.
econocemos que es posible que Ud. obtenga acceso a este Sitio Web desde
cualquier lugar en el mundo, pero no tenemos capacidad práctica para impedir
tal acceso. Este Sitio Web fue proyectado para cumplir con las leyes de la
República del Perú. Los negocios llevados a cabo por las afiliadas da SERVITARJETA
operan en varios países en todo el mundo y cumplen con las leyes de las
jurisdicciones particulares en las cuales las mismas operan. Si cualquier material
...
a Ud. y le solicitamos que no utilice el Sitio Web. Ud. es responsable por
informarse respecto a las leyes de su jurisdicción y por el cumplimiento de las
mismas.

Terminación

Usted acepta que SERVITARJETA puede, bajo ciertas circunstancias y sin necesidad de
...
y condiciones. Su uso continuado de este Sitio Web luego de la presentación de
